                                        ...
                                        >
                                            <div className="flex gap-6">
                                                {listing.images && listing.images.length > 0 ? (
                                                    ...
                                                    <div className="w-40 h-40 bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg flex items-center justify-center flex-shrink-0">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <div className="flex justify-between items-start gap-4">
                                                        <div className="flex-1 min-w-0">
                                                            <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-[#2DA5F3] transition-colors">
                                                                {listing.title}
                                                            </h3>
                                                            <div 
                                                                className="text-gray-600 mb-4 line-clamp-2 leading-relaxed prose prose-sm max-w-none"
                                                        ...
                                                        <div className="flex flex-col gap-2 flex-shrink-0">
                                                            <Button
                                                                ...
                                                                variant="outline"
                                                                size="sm"
                                                                className="rounded-lg border-gray-300 hover:border-[#2DA5F3] hover:text-[#2DA5F3] hover:bg-[#2DA5F3]/5 transition-all"
                                                                title="Редактировать"
                                                            >
                                                            ...
                                                            <Button
                                                                ...
                                                                variant="outline"
                                                                size="sm"
                                                                className="rounded-lg border-gray-300 hover:border-amber-500 hover:text-amber-600 hover:bg-amber-50 transition-all"
                                                                title="Архивировать"
                                                            >
                                                            ...
                                                            <Button
                                                                ...
                                                                variant="outline"
                                                                size="sm"
                                                                className="rounded-lg border-gray-300 hover:border-red-500 hover:text-red-600 hover:bg-red-50 transition-all"
                                                                title="Удалить"
                                                            >
