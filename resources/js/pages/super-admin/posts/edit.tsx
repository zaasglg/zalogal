...
export default function PostsEdit({ post }: PostsEditProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        router.post(`/super-admin/posts/${post.id}`, {
            _method: 'put',
            ...data,
        }, {
            forceFormData: true,
    ...
    return (
        <SuperAdminLayout title="Редактирование новости">
                    ...
                    <form onSubmit={handleSubmit} className="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            {post.image && (
                                <div className="mb-4">
                                    ...
                                    <img src={post.image} alt={post.title} className="h-32 w-auto object-cover rounded border" />
                                </div>
                            )}
                        ...
                        <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-100">
                            ...
                            >
                                ...
                                {processing ? 'Сохранение...' : 'Обновить новость'}
                            </Button>
                        </div>
                    </form>
                </div>
